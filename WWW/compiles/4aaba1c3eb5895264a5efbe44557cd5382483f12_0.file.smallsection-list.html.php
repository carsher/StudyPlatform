<?php
/* Smarty version 3.1.30, created on 2019-10-11 13:19:46
  from "F:\phpStudy20161103\phpStudy\WWW\templates\admin\smallsection-list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5da0817278c424_84784872',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4aaba1c3eb5895264a5efbe44557cd5382483f12' => 
    array (
      0 => 'F:\\phpStudy20161103\\phpStudy\\WWW\\templates\\admin\\smallsection-list.html',
      1 => 1570799661,
      2 => 'file',
    ),
  ),
...
function content_5da0817278c424_84784872 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    <thead>
      <tr class="text-c">
        ...
        <th width="130">小节资料(doc)</th>
        <th width="130">视频长度(秒)</th>
        <th width="100">操作</th>
      </tr>
    </thead>
    <tbody>
...
">已经设置</a>
        ...
        <td>
            <?php if ($_smarty_tpl->tpl_vars['val']->value['txtsource'] == 'null') {?>
            <input type="file" name="txtsource" value="选择文档资源" >
           <?php } else { ?>
            <input type="file" name="txtsource" value="选择文档资源" ><br>
            已经上传了资源文件：<?php echo $_smarty_tpl->tpl_vars['val']->value['txtsource'];?>
