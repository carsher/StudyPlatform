<?php
/* Smarty version 3.1.30, created on 2018-10-12 10:03:00
  from "D:\phpStudy\WWW\templates\admin\addanswertemple.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bc000d4391fc5_69576328',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a0552b57016706df7e551816b7f4b12daf425583' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\templates\\admin\\addanswertemple.html',
      1 => 1532144548,
      2 => 'file',
    ),
  ),
...
function content_5bc000d4391fc5_69576328 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span> 添加答题模板 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>


<div class="page-container">
	<form action="/index/addTemple" method="post" class="form form-horizontal" id="form-user-add" >
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				题目数量：</label>
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="" placeholder="" id="user-name" name="cout">
			</div>
		</div>
