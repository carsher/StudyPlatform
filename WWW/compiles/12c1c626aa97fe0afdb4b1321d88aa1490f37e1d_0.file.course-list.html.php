<?php
/* Smarty version 3.1.30, created on 2018-07-21 16:16:35
  from "G:\phpstudy\WWW\templates\admin\course-list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b52ebe3e9c9f1_88023276',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '12c1c626aa97fe0afdb4b1321d88aa1490f37e1d' => 
    array (
      0 => 'G:\\phpstudy\\WWW\\templates\\admin\\course-list.html',
      1 => 1532160935,
      2 => 'file',
    ),
  ),
...
function content_5b52ebe3e9c9f1_88023276 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span> 查看课程 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    <thead>
      <tr class="text-c">
        ...
        <th width="200">简介</th>
        <th width="130">课程类型</th>
        <th width="130">选课人数</th>
        <th width="130">总章节</th>
        <th width="120">考试设置</th>
        <th width="100">操作</th>
      </tr>
    </thead>
    <tbody>
...
?>
      <tr class="text-c">
        ...
        <td><img width="150px" height="120px" src="/courseimg/<?php echo $_smarty_tpl->tpl_vars['val']->value['img'];?>
" /></td>
        <td><?php echo $_smarty_tpl->tpl_vars['val']->value['name'];?>
</td>
        <td><?php echo $_smarty_tpl->tpl_vars['val']->value['introduce'];?>
</td>
        <td><?php echo $_smarty_tpl->tpl_vars['val']->value['type'];?>
</td>
        <td><?php echo $_smarty_tpl->tpl_vars['val']->value['hot'];?>
</td>
        <td><?php echo $_smarty_tpl->tpl_vars['val']->value['section'];?>
章</td>
        <td class="user-status">
          <?php if ($_smarty_tpl->tpl_vars['val']->value['test'] == '0') {?>
