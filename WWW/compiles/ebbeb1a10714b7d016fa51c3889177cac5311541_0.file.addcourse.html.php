<?php
/* Smarty version 3.1.30, created on 2018-07-21 11:12:12
  from "G:\phpstudy\WWW\templates\admin\addcourse.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b52a48c650048_72041717',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ebbeb1a10714b7d016fa51c3889177cac5311541' => 
    array (
      0 => 'G:\\phpstudy\\WWW\\templates\\admin\\addcourse.html',
      1 => 1532142718,
      2 => 'file',
    ),
  ),
...
function content_5b52a48c650048_72041717 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="/index/addCourse" method="post" class="form form-horizontal" id="form-user-add" enctype="multipart/form-data" >
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				课程总章节：</label>
			<div class="formControls col-xs-6 col-sm-6">
				<input type="text" class="input-text" value="" placeholder="" id="user-name" name="section">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<textarea name="introduce" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,255)"></textarea>
